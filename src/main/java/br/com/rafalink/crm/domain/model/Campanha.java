...
@Entity @Table(name="campanhas") @Data @Builder @NoArgsConstructor @AllArgsConstructor
public class Campanha {
    ...
    @Enumerated(EnumType.STRING) @Column(nullable=false, length=50) private CanalCampanha canal;
